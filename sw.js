// MB Gestor Luxury Pro V12.8.2 — Avaliação Postural Premium • Alignment Precision Hotfix
const CACHE='mb-gestor-luxury-pro-v12-8-2-postural-alignment-precision';
const ASSETS=['./','./index.html','./styles.css?v=12.8.2','./app.js?v=12.8.2','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
