// MB Gestor Luxury Pro V12.18.2 — Portal do Aluno • Convite Compacto e Experiência Comercial
const CACHE='mb-gestor-luxury-pro-v12-18-2-compact-invite';
const ASSETS=['./','./index.html','./styles.css?v=12.18.2','./app.js?v=12.18.2','./student-portal.html','./student-portal.js?v=12.18.2','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
