// MB Gestor Luxury Pro V12.18.2.1 — Portal do Aluno • Convite Compacto e Experiência Comercial
const CACHE='mb-gestor-luxury-pro-v12-18-2-1-ios-otp-hotfix';
const ASSETS=['./','./index.html','./styles.css?v=12.18.2.1','./app.js?v=12.18.2.1','./student-portal.html','./student-portal.js?v=12.18.2.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
