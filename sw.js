...
const CACHE='mb-gestor-luxury-pro-v12-11-6-assessment-evolution-360-highlight';
const ASSETS=['./','./index.html','./styles.css?v=12.11.6','./app.js?v=12.11.6','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
