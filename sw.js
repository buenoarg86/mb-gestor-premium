...
const CACHE='mb-gestor-luxury-pro-v12-11-0-commercial-data-foundation';
const ASSETS=['./','./index.html','./styles.css?v=12.11.0','./app.js?v=12.11.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
