// MB Gestor Luxury Pro V12.14.2 — Hotfix • Código de Recuperação Visível
const CACHE='mb-gestor-luxury-pro-v12-14-2-owner-recovery-ui-hotfix';
const ASSETS=['./','./index.html','./styles.css?v=12.14.2','./app.js?v=12.14.2','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
