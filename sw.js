...
const CACHE='mb-gestor-luxury-pro-v12-18-0-student-portal-identity-access';
const ASSETS=['./','./index.html','./styles.css?v=12.18.0','./app.js?v=12.18.0','./student-portal.html','./student-portal.js?v=12.18.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
