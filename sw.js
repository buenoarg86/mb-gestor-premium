...
const CACHE='mb-gestor-luxury-pro-v12-18-1-student-portal-rpc-hotfix';
const ASSETS=['./','./index.html','./styles.css?v=12.18.1','./app.js?v=12.18.1','./student-portal.html','./student-portal.js?v=12.18.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
