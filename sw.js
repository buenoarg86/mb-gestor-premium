...
const CACHE='mb-gestor-luxury-pro-v12-12-0-protected-commercial-backup';
const ASSETS=['./','./index.html','./styles.css?v=12.12.0','./app.js?v=12.12.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
