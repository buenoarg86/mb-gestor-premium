...
const CACHE='mb-gestor-luxury-pro-v12-18-8-portal-compact';
const ASSETS=['./','./index.html','./styles.css?v=12.18.8','./app.js?v=12.18.8','./student-portal.html','./student-portal.js?v=12.18.8','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
