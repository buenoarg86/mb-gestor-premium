// MB Gestor Luxury Pro V12.8.0 — Avaliação Postural Premium • Boneco Premium
const CACHE='mb-gestor-luxury-pro-v12-8-0-postural-boneco-premium';
const ASSETS=['./','./index.html','./styles.css?v=12.8.0','./app.js?v=12.8.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
