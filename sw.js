...
const CACHE='mb-gestor-luxury-pro-v12-14-0-local-team-session';
const ASSETS=['./','./index.html','./styles.css?v=12.14.0','./app.js?v=12.14.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
