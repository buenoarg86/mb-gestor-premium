// MB Gestor Luxury Pro V12.8.1 — Avaliação Postural Premium • Calibração Anatômica Final
const CACHE='mb-gestor-luxury-pro-v12-8-1-postural-anatomical-calibration';
const ASSETS=['./','./index.html','./styles.css?v=12.8.1','./app.js?v=12.8.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
