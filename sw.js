...
const CACHE='mb-gestor-luxury-pro-v12-9-0-receipts-premium';
const ASSETS=['./','./index.html','./styles.css?v=12.9.0','./app.js?v=12.9.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
