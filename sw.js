// MB Gestor Luxury Pro V12.14.1 — Hotfix • Rotação de Credenciais e Feedback de Acesso
const CACHE='mb-gestor-luxury-pro-v12-14-1-credential-rotation-hotfix';
const ASSETS=['./','./index.html','./styles.css?v=12.14.1','./app.js?v=12.14.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
