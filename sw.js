...
const CACHE='mb-gestor-luxury-pro-v12-11-7-assessment-integrated-presentation';
const ASSETS=['./','./index.html','./styles.css?v=12.11.7','./app.js?v=12.11.7','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
