...
const CACHE='mb-gestor-luxury-pro-v12-10-1-desktop-polish';
const ASSETS=['./','./index.html','./styles.css?v=12.10.1','./app.js?v=12.10.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
