// MB Gestor Luxury Pro V12.8.3 — Avaliação Postural Premium • Lateral Segment Active Marker Fix
const CACHE='mb-gestor-luxury-pro-v12-8-3-lateral-segment-active-marker';
const ASSETS=['./','./index.html','./styles.css?v=12.8.3','./app.js?v=12.8.3','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
