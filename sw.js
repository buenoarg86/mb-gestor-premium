...
const CACHE='mb-gestor-luxury-pro-v12-17-1-student-portal-superdb-br';
const ASSETS=['./','./index.html','./styles.css?v=12.17.1','./app.js?v=12.17.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
