...
const CACHE='mb-gestor-luxury-pro-v13-0-0-commercial-saas';
const ASSETS=['./','./index.html','./styles.css?v=13.0.0','./app.js?v=13.0.0','./student-portal.html','./student-portal.js?v=13.0.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
