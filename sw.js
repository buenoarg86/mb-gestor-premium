...
const CACHE='mb-gestor-luxury-pro-v12-5-0-plan-license-center';
const ASSETS=['./','./index.html','./styles.css?v=12.5.0','./app.js?v=12.5.0','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
