// MB Gestor Luxury Pro V13.1.1 — Comercial • Isolamento Multi-Studio Seguro
const CACHE='mb-gestor-luxury-pro-v13-1-2-commercial-bootstrap';
const ASSETS=['./','./index.html','./styles.css?v=13.1.1','./app.js?v=13.1.1','./student-portal.html','./student-portal.js?v=13.1.1','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
